...
public class QuestionOne extends Fragment {
   ...
   // int numCorrect = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = inflater.inflate(R.layout.question1, container, false);

        submit1 = (Button)view.findViewById(R.id.submitButton1);
        return view;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        submit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String answer;
                answer1Text = (EditText)getActivity().findViewById(R.id.answer1);
                userAnswer = answer1Text.getText().toString();
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.main_fragment_container, new QuestionTwo())
                        .addToBackStack(null)
                        .commit();
            }
        });
